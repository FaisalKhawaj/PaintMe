    ...
    <Container style={styles.safeArea}>
      ...
      <View style={styles.header}>
        <View style={styles.iconWrapper}>
          <BlurredIcon icon="ArrowLeftIcon" handleClick={handleBack} />
        </View>
      ...
      <ScrollView contentContainerStyle={[styles.container, { flexGrow: 1 }]}>
                ...
                <Pressable onPress={() => handleImagePress(img)}>
                  <Image
                    ...
                    style={[
                      styles.image,
                      index === 0
                        ? styles.leftImageHeightFirst
                        : styles.leftImageHeight,
                    ]}
                  />
                </Pressable>
              </MotiView>
                ...
                <Pressable onPress={() => handleImagePress(img)}>
                  <Image
                    ...
                    style={[
                      styles.image,
                      index === 0
                        ? styles.rightImageHeightFirst
                        : styles.rightImageHeight,
                    ]}
                  />
                </Pressable>
              </MotiView>
        ...
        <Container>
          <CustomModal
            isVisible={showImagePinched}
            setIsVisble={setShowImagePinched}
          >
